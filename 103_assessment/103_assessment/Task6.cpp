...
void addRecord(Expenses r, int *ptr, int type) {
	...
	//dailyRecorder[10] = summary;
	
	/*cout << "Would you like to view Records?\n 1. Yes 2. No";
	cin >> choice;
	if (choice == 1) {
		viewDailyReport(summary, type);
	}*/
	start();
}
...
void viewExpenses() {
	int choice;
	cout << "would you like to :\n 1. view daily expenses 2. view weekly expenses ?\n";
	cin >> choice;
	switch (choice) {
	case 1:
		viewDailyExpenses();
...
void viewDailyReport(Expenses r, int type) {
	
	int choice;

	cout << "1. Weekly or 2.Daily expenses?\n";
	cin >> choice;
